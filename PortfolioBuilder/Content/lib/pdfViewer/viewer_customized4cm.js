...
PDFJS.imageResourcesPath = app.settings.imageResourcesPath;
PDFJS.workerSrc = app.settings.workerSrc;
PDFJS.cMapUrl = app.settings.cMapUrl;
...
function webViewerInitialized() {
  ...
  var file = 'file' in params ? params.file : app.settings.pdfEndpointUrl;
  ...
  if (!PDFView.supportsPrinting || !app.settings.showPrintButton) {
...
function printPDF()
{
    if (app.settings.PDFDialogPrint) {        
        var url = app.settings.pdfEndpointUrl + "&PDFDialogPrint=true";
        var object = document.getElementById("mypdfobject");
        if(object==null)
            object = document.createElement("object");

        object.setAttribute("id", "mypdfobject");
